...
void ShaderProgram::set4f(std::string const& uniformName, float v0, float v1, float v2, float v3) {
	setGeneric(uniformName, [&v0, &v1, &v2, &v3](auto location) { glUniform4f(location, v0, v1, v2, v3); });
}
